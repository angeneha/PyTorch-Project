...
# ANGENE is evaluating the model predictions on the test set - using parity plots to visualize the difference between the actual test sequence scores vs the model’s predicted scores.
