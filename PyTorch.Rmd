...
# Goal: Create a program that models DNA sequences with Pytorch and predicts patterns of simple DNA sequences.

# Consultation: "Modeling DNA Sequences with PyTorch" by Erin Wilson #
